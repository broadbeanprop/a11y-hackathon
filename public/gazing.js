...
function getElementByCoordinates({x, y}) {
    ...
    if (element) {
        element = element.closest(HOVERABLE_ITEMS);
    }
    ...
    */
    ...
    if (GazeData.state != 0) {
        ...
        if (isGazing(GazeData)) {
            ...
            if (timestamp + 1500 < GazeData.time) {
            ...
            if (timestamp + 3000 < GazeData.time) {
                ...
                if (elementToClick) {
                    const ABOUT_TO_CLICK_CLASS = "about-to-click";

                    elementToClick.classList.add(ABOUT_TO_CLICK_CLASS);

                    setTimeout(() => {
                        elementToClick.classList.remove(ABOUT_TO_CLICK_CLASS);
                    }, 1000);
